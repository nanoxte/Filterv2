...
BOT_TOKEN = environ.get('BOT_TOKEN', '7122607428:AAFoIs5m7aTa4GxtWKNMAACL1j9PAKXTJNE')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1352497419').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1352497419').split()]
...
SUPPORT_CHAT_ID = -1002072099903
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tera:tera@tera.oq2hwag.mongodb.net/?retryWrites=true&w=majority&appName=tera")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1002072099903))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002072099903')).split()]
